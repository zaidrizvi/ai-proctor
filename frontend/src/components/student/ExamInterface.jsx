...
const BASELINE_MAX_MOVEMENT_SCORE = 1.3;
const BASELINE_MAX_COMBINED_MOVEMENT_SCORE = 1.25;
const BASELINE_MAX_GAZE_SCORE = 1.08;
const BASELINE_MAX_COMBINED_GAZE_SCORE = 1.05;
const BASELINE_MIN_GAZE_FACE_CONFIDENCE = 0.6;
const BASELINE_MIN_GAZE_FACE_AREA_RATIO = 0.052;
